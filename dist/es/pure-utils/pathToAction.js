...
export default ((pathname, routesMap, serializer, basename = getOptions().basename, strict = getOptions().strict) => {
  ...
  if (match) {
    ...
    const coerceNumbers = typeof routes[i] === 'object' && routes[i].coerceNumbers;
