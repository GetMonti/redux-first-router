...
export default ((action, routesMap, prevLocation, history, notFoundPath, serializer) => {
  try {
    ...
    return nestAction(notFoundPath || prevLocation.pathname || '/', { ...action,
      type: NOT_FOUND,
      payload
...
const getKind = (isMemoryHistory, pathname, history, action) => {
